...
VanillaEEAgentObserver::VanillaEEAgentObserver( )
{
}

VanillaEEAgentObserver::VanillaEEAgentObserver( RobotWorldModel *__wm )
{
	_wm = __wm;
}
...
void VanillaEEAgentObserver::reset()
{
	// nothing to do.
}

void VanillaEEAgentObserver::step()
{
